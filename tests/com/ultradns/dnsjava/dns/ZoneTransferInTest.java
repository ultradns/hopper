...
public class ZoneTransferInTest extends TestCase {
	...
	public void test_extraDataInIXFRResponse() throws Exception {
		...
		ZoneTransferIn newIXFR = ZoneTransferIn
				.newIXFR(new Name("example.biz."), 2008021850l, false, "localhost", null);
	...
	public void test_incorrectQuestionTypeInIXFRResponse() throws Exception {
		...
		// fail by default
		ZoneTransferIn newIXFR = ZoneTransferIn
				.newIXFR(new Name("example.biz."), 2011071501l, false, "localhost", null);
	...
	public static class StringTCPClient implements TCPClient {
		...
		public byte[] recv() throws IOException {
			// return Base64.decodeBase64(wireMessage);
			try {
				return Hex.decodeHex(wireMessage.toCharArray());
	...
	String ixfrResponseExtraDataHex = 
		"a27f8400000100750000000003623262096d616371756172696503636f6d0000fb0001c00c0006000"+
	...
	String ixfrResponseWrongQuestionHex = 
		      "58078400000100070000000017657870657274666f6f7462616c6c6368616c6c656e676503636f6"
