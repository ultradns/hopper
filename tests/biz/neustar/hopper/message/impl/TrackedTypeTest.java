...
public class TrackedTypeTest {
    ...
    public void testTrackedType() {
        ...
        assertEquals("{name=nothing, value=nothing, alternativeNames=[a, b, c]}", type.toString());
    }
    ...
    public void testTrackedTypeTestImpl() {
        assertEquals("TrackedTypeTestImpl{name=nothing, value=nothing, alternativeNames=[a, b, c]}", 
