...
import biz.neustar.hopper.record.A6Record;
import biz.neustar.hopper.record.AAAARecord;
...
import biz.neustar.hopper.record.DLVRecord;
...
import biz.neustar.hopper.record.GPOSRecord;
import biz.neustar.hopper.record.HINFORecord;
import biz.neustar.hopper.record.IPSECKEYRecord;
import biz.neustar.hopper.record.ISDNRecord;
import biz.neustar.hopper.record.KEYRecord;
import biz.neustar.hopper.record.KXRecord;
import biz.neustar.hopper.record.LOCRecord;
import biz.neustar.hopper.record.MBRecord;
import biz.neustar.hopper.record.MDRecord;
import biz.neustar.hopper.record.MFRecord;
import biz.neustar.hopper.record.MGRecord;
import biz.neustar.hopper.record.MINFORecord;
import biz.neustar.hopper.record.MRRecord;
import biz.neustar.hopper.record.MXRecord;
import biz.neustar.hopper.record.NAPTRRecord;
import biz.neustar.hopper.record.NSAPRecord;
import biz.neustar.hopper.record.NSAP_PTRRecord;
import biz.neustar.hopper.record.NSEC3PARAMRecord;
import biz.neustar.hopper.record.NSEC3Record;
import biz.neustar.hopper.record.NSECRecord;
import biz.neustar.hopper.record.NSRecord;
import biz.neustar.hopper.record.NULLRecord;
import biz.neustar.hopper.record.NXTRecord;
...
import biz.neustar.hopper.record.X25Record;
...
public final class Type {
    ...
    // TODO: we should fix this 'factory'
    static {
