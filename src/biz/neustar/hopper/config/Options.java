...
package biz.neustar.hopper.config;
 ...
 * ignoreextradata - Ignore extra resource records after the apparent end of a
 * message ignoreresponsequestiontype - Ignore an incorrect question type in the
 * response <BR>
 * Valued options:<BR>
