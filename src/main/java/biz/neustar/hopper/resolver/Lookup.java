...
public final class Lookup {
    ...
    public static synchronized void setDefaultCache(Cache cache, int dclass) {
        if (DClass.valueOf(dclass) != null) { // may throw... TODO: check it and store the DClass not int
    ...
    /**
     * Sets ndots to use when performing this lookup, overriding the default
     * value. Specifically, this refers to the number of "dots" which, if
     * present in a name, indicate that a lookup for the absolute name should be
     * attempted before appending any search path elements.
     * 
     * @param ndots
