...
public abstract class Record implements Cloneable, Comparable<Record>, Serializable {
    ...
    public static Record fromWire(DNSInput in, int section, boolean isUpdate)
        ...
        name = new Name(in);
        type = in.readU16();
        dclass = DClass.valueOf(in.readU16());
    ...
    protected static Record fromWire(DNSInput in, int section) throws IOException {
     ...
     * Converts the type-specific RR to wire format - must be overriden
     */
    public abstract void rrToWire(DNSOutput out, Compression c, boolean canonical);
